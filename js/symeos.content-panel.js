...
;(function($, document)
{
	...
	/**
	 * Load navigation panel content with an HTML string
	 * @param string url the html of the content to load
	 */
	...
	/**
	 * Load content panel content with an HTML string
	 * @param string url the HTML of the content to load
	 */
	...
	function loadPanelContent(url, wrapper, panel, isNav)
	{
		...
		/* ModifiŽ par raoul : l'url contient directement l'HTML en fait. On fait pas d'appel AJAX */
		target.html(url);
